...
public class MainActivity extends AppCompatActivity
    ...
    String urlHome = "https://praveensharma.cf/";
    final String url="https://praveensharma.cf/ADhome.html";
...
//    }
     ...
     void webSettings(){
        ...
        mWebView.setWebViewClient(new WebViewClient()
        {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if(url.contains("youtube.com") || url.contains("play.google.com") || url.contains("google.com/maps") || url.contains("facebook.com") || url.contains("twitter.com") || url.contains("instagram.com") || url.contains("drive.google.com") || url.contains("linkedin.com")){
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        else if(id == R.id.action_hideCat){
//            menuItem.setVisible(false);
            Menu navMenuLogIn = navigationView.getMenu();
            if(navMenuLogIn.findItem(R.id.nav_Category).isVisible()) {
                navMenuLogIn.findItem(R.id.nav_Category).setVisible(false);
                item.setTitle("Show Category");
                Snackbar snackbar = Snackbar.make(drawerLayout, "Category Hiden.", Snackbar.LENGTH_SHORT);
                snackbar.show();
//                frameLayout.setVisibility(View.VISIBLE);
//                fragment = new All_Others();
//                ((All_Others) fragment).url = "https://google.com";
//                ((All_Others) fragment).title = "Google Search";
                fragment = null;
                ...
                navMenuLogIn.findItem(R.id.nav_Category).setVisible(true);
                item.setTitle("Hide Category");
                Snackbar snackbar = Snackbar.make(drawerLayout, "Category Shown.", Snackbar.LENGTH_SHORT);
                snackbar.show();
//                frameLayout.setVisibility(View.VISIBLE);
//                fragment = new All_Others();
//                ((All_Others) fragment).url = urlHome+"ADhome.html";
//                ((All_Others) fragment).title = "Home";
                fragment = null;
                setTitle("Home");
                mWebView.setVisibility(View.VISIBLE);
                frameLayout.setVisibility(View.GONE);
...
//        sharingIntent.putExtra(android.content.Intent.EXTRA_TEXT, "You can view Very Important Stuff at : "+mWebView.getUrl());
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        // Home
         ...
         // Profile
            ...
            frameLayout.setVisibility(View.VISIBLE);
            fragment = new All_Others();
            ((All_Others) fragment).url = urlHome+"ADprofile.html";
             ((All_Others) fragment).title = "Profile";
         ...
         // Resume
            ...
            frameLayout.setVisibility(View.VISIBLE);
            fragment = new All_Others();
            ((All_Others) fragment).url = urlHome+"resume.htm";
             ((All_Others) fragment).title = "Resume";
//            ((All_Others) fragment).getActivity().setTitle("Resume");
        }
         // Projects
         else if(id == R.id.nav_projects) {
            frameLayout.setVisibility(View.VISIBLE);
            fragment = new All_Others();
            ((All_Others) fragment).url = urlHome+"ADportfolio.html";
             ((All_Others) fragment).title = "Projects";
//             ((All_Others) fragment).getActivity().setTitle("Projects");
         ...
         //Contacts
            ...
            frameLayout.setVisibility(View.VISIBLE);
            fragment = new All_Others();
            ((All_Others) fragment).url = urlHome+"ADcontact.html";
             ((All_Others) fragment).title = "Contact";
//             ((All_Others) fragment).getActivity().setTitle("Contact");
         ...
         // Blog
            ...
            frameLayout.setVisibility(View.VISIBLE);
            fragment = new All_Others();
            ((All_Others) fragment).url = "https://procoder01.blogspot.com/";
             ((All_Others) fragment).title = "Blog";
//             ((All_Others) fragment).getActivity().setTitle("Blog");
...
//            ((All_Others) fragment).url = "https://praveensharma.cf";
             ((LinksFragment) fragment).title = "Links";
//             ((All_Others) fragment).getActivity().setTitle("Links");
         ...
         //About
            ...
            frameLayout.setVisibility(View.VISIBLE);
            fragment = new All_Others();
            ((All_Others) fragment).url = urlHome+"ADabout.html";
             ((All_Others) fragment).title = "About";
//            fragment.getActivity().setTitle("About");
...
//             final String m_Text;// = "www.example.com";
            ...
            // Set up the buttons
             builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                 ...
                 public void onClick(DialogInterface dialog, int which) {
                     ...
                     frameLayout.setVisibility(View.VISIBLE);
                     fragment = new All_Others();
                     ((All_Others) fragment).url = m_Text;
                     ((All_Others) fragment).title = m_Text;
                     dialog.cancel();
